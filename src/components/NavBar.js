      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6">
          <div className="flex justify-start lg:w-0 lg:flex-auto">
            <a href="#"></a>
            <div className="lg:text-2xl md:text-lg sm:text-sm font-bold">
              Financial Advisor
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-20 justify-end w-max">
            <nav className="hidden md:flex space-x-10 w-full">
              <a
                href="#"
            ...
            <div className="hidden md:flex items-center md:flex-1 lg:w-full">
              <a
                href="#"
